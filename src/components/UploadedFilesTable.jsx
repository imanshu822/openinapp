      ...
      <table className="w-full bg-[#f2f2f2] rounded-lg">
        ...
        <tbody>
          {files.map((file, index) => (
            <tr key={index} className="bg-white rounded-lg shadow-md p-5 mb-5">
              <td>
                <p className="rounded-l-md ml-4 pl-6 py-3">
                  <span>0</span>
                  {index + 1}
                </p>
              </td>
              <td>
                <p className="py-3 text-blue-400 underline">
                  <a href="http://www.google.com">www.google.com</a>
                </p>
              </td>
              <td>
                <p className="py-3">{file.prefix}</p>
              </td>
              <td>
                <p className="py-3">
                  <select
              ...
              <td>
                <div className="py-3">
                  {selectedTagsMap[index] &&
                    selectedTagsMap[index].map((tag, idx) => (
                      <span
                        key={idx}
